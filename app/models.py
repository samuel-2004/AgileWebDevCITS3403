...
class User(UserMixin, db.Model):
  ...
  address: so.Mapped[Address] = so.relationship(back_populates='resident')
  replies: so.WriteOnlyMapped['Reply'] = so.relationship(foreign_keys = "Reply.user_id",back_populates='author')
