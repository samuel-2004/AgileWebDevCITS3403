...
Revision ID: 82684acb0ae6
Revises: 
Create Date: 2024-04-26 17:29:40.015710
...
def upgrade():
    ...
    with op.batch_alter_table('user', schema=None) as batch_op:
        ...
        batch_op.create_index(batch_op.f('ix_user_time_created'), ['time_created'], unique=False)
...
def downgrade():
    ...
    with op.batch_alter_table('user', schema=None) as batch_op:
        ...
        batch_op.drop_index(batch_op.f('ix_user_time_created'))
